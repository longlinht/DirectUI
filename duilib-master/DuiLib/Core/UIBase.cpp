...
HWND CWindowWnd::Subclass(HWND hWnd)
{
	...
	//Change the HWND's procedure function to __WndProc and store the default procedure function.
	//Let __WndProc do with special message,the default message still processed by default procedure function.
...
LRESULT CALLBACK CWindowWnd::__WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    if( uMsg == WM_NCCREATE ) {// 要在此消息中把类与窗口进行绑定  
