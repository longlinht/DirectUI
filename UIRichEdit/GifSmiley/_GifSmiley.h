...
#ifndef ___GifSmiley_h__
#define ___GifSmiley_h__
...
EXTERN_C const IID IID_IGifSmileyCtrl;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE InsertAniSmiley( 
            /* [in] */ long hwndHostWindow,
            /* [in] */ BSTR bstrFileName,
            /* [in] */ OLE_COLOR clr,
            /* [in] */ INT cy) = 0;
    ...
    typedef struct IGifSmileyCtrlVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *InsertAniSmiley )( 
            IGifSmileyCtrl * This,
            /* [in] */ long hwndHostWindow,
            /* [in] */ BSTR bstrFileName,
            /* [in] */ OLE_COLOR clr,
...
#define IGifSmileyCtrl_InsertAniSmiley(This,hwndHostWindow,bstrFileName,clr,cy)	\
    (This)->lpVtbl -> InsertAniSmiley(This,hwndHostWindow,bstrFileName,clr,cy)
...
/* [id] */ HRESULT STDMETHODCALLTYPE IGifSmileyCtrl_InsertAniSmiley_Proxy( 
    IGifSmileyCtrl * This,
    /* [in] */ long hwndHostWindow,
    /* [in] */ BSTR bstrFileName,
    /* [in] */ OLE_COLOR clr,
...
void __RPC_STUB IGifSmileyCtrl_InsertAniSmiley_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [helpstring][id][propget] */ HRESULT STDMETHODCALLTYPE IGifSmileyCtrl_get_FileName_Proxy( 
    IGifSmileyCtrl * This,
    /* [retval][out] */ BSTR *pVal);


void __RPC_STUB IGifSmileyCtrl_get_FileName_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_IGifSmileyCtrl2;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE ShowHint( void) = 0;
    ...
    typedef struct IGifSmileyCtrl2Vtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *ShowHint )( 
            IGifSmileyCtrl2 * This);
...
#define IGifSmileyCtrl2_ShowHint(This)	\
    (This)->lpVtbl -> ShowHint(This)
...
/* [id] */ HRESULT STDMETHODCALLTYPE IGifSmileyCtrl2_SetHint_Proxy( 
    IGifSmileyCtrl2 * This,
    /* [in] */ BSTR bstrHint);


void __RPC_STUB IGifSmileyCtrl2_SetHint_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id] */ HRESULT STDMETHODCALLTYPE IGifSmileyCtrl2_GetHint_Proxy( 
    IGifSmileyCtrl2 * This,
    /* [retval][out] */ BSTR *bstrHint);


void __RPC_STUB IGifSmileyCtrl2_GetHint_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* [id] */ HRESULT STDMETHODCALLTYPE IGifSmileyCtrl2_ShowHint_Proxy( 
    IGifSmileyCtrl2 * This);


void __RPC_STUB IGifSmileyCtrl2_ShowHint_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
